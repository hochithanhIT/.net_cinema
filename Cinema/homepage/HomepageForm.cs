...
//        public HomepageForm(string fullName, string email, string phone, DateTime dob, string spending, string rankName, decimal discount, int memberId = -1)
//        {
//            InitializeComponent();
...
//            this.RankName = rankName;
//            this.Discount = discount;
//            this._memberId = memberId; // Lưu memberId

//            // Khởi tạo và thêm header_bar vào form
//            headerBar = new header_bar(fullName, email, phone, dob, spending, rankName, discount, memberId);
