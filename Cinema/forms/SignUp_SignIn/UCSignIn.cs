                        ...
                        if (dt.Rows.Count == 1)
                        {
                            ...
                            if (BCrypt.Net.BCrypt.Verify(password, hashedPassword))
                            {
                                ...
                                else
                                {
                                    ...
                                    nextForm = new HomepageForm(fullName, email, phone, dob, spending.ToString(), rankName, discount);
                                }
...
//using System.Text.RegularExpressions;
//using Cinema.forms.Admin;
//using Cinema.homepage; // Thêm namespace để truy cập HomepageForm
...
//                                else
//                                {
//                                    // Truyền fullName vào HomepageForm
//                                    nextForm = new HomepageForm(fullName);
//                                }
