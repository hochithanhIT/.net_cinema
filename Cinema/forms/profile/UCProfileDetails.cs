...
//                //Set up event handlers (remove manual subscription to avoid duplication)
//                btnSave.Click += btnSave_Click; // Comment out or remove this line
//                btnChangePassword.Click += btnChangePassword_Click;
...
//                if (!isFullNameChanged && !isPhoneChanged && !isDoBChanged)
//                {
//                    MessageBox.Show("No changes detected. Please update at least one field to save.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
//                    return;
//                }
...
//                    {
//                        MessageBox.Show("This phone number is already registered with another account. Please use a different phone number.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
//                        return;
//                    }
//                }
...
//            DateTime currentDate = DateTime.Now; // Use the actual current date
...
//            // Optional: Ensure the user is at least a certain age (e.g., 13 years old)
//            int minimumAge = 13;
//            if (dtpDoB.Value > currentDate.AddYears(-minimumAge))
//            {
//                MessageBox.Show($"You must be at least {minimumAge} years old to register.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
//                return false;
//            }
...
namespace Cinema.Forms.profile
{
    public partial class UCProfileDetails : UserControl
    {
        ...
        private bool ValidateInputs()
        {
            ...
            // Optional: Ensure the user is at least 13 years old
            int minimumAge = 13;
            if (dtpDoB.Value > currentDate.AddYears(-minimumAge))
            {
