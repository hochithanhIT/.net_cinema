...
//        private int _memberId; // Lưu memberId
//        private int _movieId; // Lưu movieId (nếu có)

//        public Movie_Schedule(int memberId, int movieId = -1) { // Thêm tham số movieId
//            InitializeComponent();
//            _memberId = memberId;
//            _movieId = movieId; // Lưu movieId
//        }
...
//                DateTime today = DateTime.Today; // Ngày hiện tại (26/03/2025)
...
//                                    // Mở form Booking_Ticket
//                                    Booking_Ticket bookingForm = new Booking_Ticket(scheduleId, _memberId);
...
//        private int _memberId; // Lưu memberId
//        private int _movieId; // Lưu movieId (nếu có)
//        private string _fullName; // Thông tin người dùng
...
//        public Movie_Schedule(int memberId, string fullName = null, string email = null, string phone = null, DateTime? dob = null, string spending = null, string rankName = null, decimal discount = 0, int movieId = -1)
//        {
//            InitializeComponent();
//            _memberId = memberId;
//            _movieId = movieId;
...
//            _headerBar = new header_bar(_fullName, _email, _phone, _dob, _spending, _rankName, _discount, _memberId);
